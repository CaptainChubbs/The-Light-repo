  ...
  <section id="nurse-login">
    <div class="container-fluid d-flex align-items-center justify-content-center" style="padding: 50px 0">
      ...
      <form action="auth.php" method="post">
        <h1 class="h1 text-center" style="color: #798A70; margin: auto; padding-bottom:10px">Nurse Portal Login</h1>
        <p class="text-center" style="padding-bottom: 30px;">Login to the portal to access your information</p>
        ...
        <div class="mb-3">
          ...
          <input name="email" type="email" class="form-control" id="email-login">
        </div>
        <!--Password Entry-->
        <div class="mb-3">
        ...
        <!--Register Option-->
        <p>Want to join the Network? <a class="" href="nurse-registration.php">Register Here</a></p>
        <?php echo $output; ?>
      </form>
  </section>
