<nav class="navbar navbar-expand-lg  p-0">
        <div class="container-fluid p-0 m-0 ">
            <a class=" px-4 navbar-brand p-0 m-0" href="https://abahlengi.com/">
                <img src="https://abahlengi.com/assets/img/transparent_logo.png" alt="Abahlengi Logo" width="100" height="100">
              </a>
          ...
          if (isset($_SESSION['loggedin'])) {
            ...
            echo '<a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <ul class="dropdown-menu ">
                  ...
                  <li><a class="dropdown-item" href="ttp://nurse.abahlengi.com/client-login.php">Client Login</a></li>
                </ul>';
          }
