...
$googleMapsApiKey = "AIzaSyDjlWl9AFidUCGehPK7GLMTtLIfGMFtva0";
// Add the Google Chat API scope
...
if (isset($_SESSION['access_token']) && $_SESSION['access_token']) {
    ...
    // Pass the access token to JavaScript
    echo "<script>var accessToken = '" . $_SESSION['access_token'] . "';</script>";
}
